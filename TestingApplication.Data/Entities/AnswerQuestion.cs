...
namespace TestingApplication.Data.Entities
{
    ...
    {
        private byte[]? _questionId;
        private Question _question;
        private Answer _answer;
        private byte[]? _answerId;
        private bool _isTrue;

        public byte[]? QuestionId { get => _questionId; set => _questionId = value; }
        public virtual Question Question { get => _question; set => _question = value; }
        public byte[]? AnswerId { get => _answerId; set => _answerId = value; }
